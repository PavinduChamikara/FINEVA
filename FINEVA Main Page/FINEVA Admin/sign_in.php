...
<?php
     ...
     if(isset($_POST['submit']))
     {
         ...
         $query = "SELECT*FROM police_admin WHERE ad_sid='{$ad_sid}' AND pswd='{$ad_pswd}' LIMIT 1";
        ...
        <div class="col-12 col-md-9 col-lg-7 col-xl-6">
          <div class="card" style="border-radius: 15px;">
            <div class="card-body p-5">
              <h2 class="text-uppercase text-center mb-5">Welcome Admin!</h2>
